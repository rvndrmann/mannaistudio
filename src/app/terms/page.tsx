    ...
    return (
        <main className="min-h-screen">
            ...
            <article className="pt-32 pb-20 px-6 max-w-3xl mx-auto prose prose-invert prose-sm prose-headings:font-bold prose-p:text-white/60 prose-li:text-white/60 prose-strong:text-white">
                ...
                <p>The Platform is owned by <strong>Ravinder Deep Singh</strong>, a proprietorship having its registered office at <strong>VPO Barwala, Panchkula, Haryana 134118, India</strong> (hereinafter referred to as 'Platform Owner', 'we', 'us', 'our').</p>
                ...
                <ul>
                    ...
                    <li><strong>Registered Address:</strong> VPO Barwala, Panchkula, Haryana 134118, India</li>
