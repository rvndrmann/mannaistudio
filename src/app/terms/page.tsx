    ...
    return (
        <main className="min-h-screen">
            ...
            <article className="pt-32 pb-20 px-6 max-w-3xl mx-auto prose prose-invert prose-sm prose-headings:font-bold prose-p:text-white/60 prose-li:text-white/60 prose-strong:text-white">
                ...
                <p>This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name <strong>https://www.aidirectorhub.com/</strong> ('Website'), including the related mobile site and mobile application (hereinafter referred to as 'Platform').</p>
                <p>The Platform is owned by <strong>Ravinder Deep Singh</strong>, a proprietorship having its registered office at <strong>597, VPO Barwala, Panchkula, Haryana 134118, India</strong> (hereinafter referred to as 'Platform Owner', 'we', 'us', 'our').</p>
                ...
                <ol>
                    ...
                    <li>All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in <strong>Panchkula, Haryana</strong>.</li>
                ...
                <ul>
                    <li><strong>Business:</strong> Ravinder Deep Singh (Proprietor), AI Director Hub</li>
                    <li><strong>Registered Address:</strong> 597, VPO Barwala, Panchkula, Haryana 134118, India</li>
