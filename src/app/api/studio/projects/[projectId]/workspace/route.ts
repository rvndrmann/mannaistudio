...
export async function POST(request: NextRequest, { params }: { params: Promise<{ projectId: string }> }) {
  try {
    ...
    if (body.action === "saveShot") {
      const payload = { title: body.shot.title, prompt: body.shot.prompt || null, duration_seconds: body.shot.duration_seconds || 4, aspect_ratio: body.shot.aspect_ratio || "9:16", resolution: body.shot.resolution || "720p", model: body.shot.model || "Cinematic", referenced_entities: body.shot.entityIds || [] }
