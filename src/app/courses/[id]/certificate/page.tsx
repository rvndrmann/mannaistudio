...
import { Download, Share2, Award, ShieldCheck, CheckCircle2, ArrowLeft } from "lucide-react"
            ...
            <section className="pt-32 px-6 max-w-5xl mx-auto flex flex-col items-center">
                ...
                >
                    ...
                    <div className="absolute bottom-8 flex items-center gap-2 opacity-20">
                        ...
                        <span className="text-[10px] tracking-widest font-mono">VERIFY: AIM-2938-X82-2024</span>
                    </div>
                </motion.div>
