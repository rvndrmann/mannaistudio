      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <div className="flex items-center gap-2">
            <p className="text-xs font-bold tracking-[.18em] text-[#b9f42e] uppercase">Organic Marketing Intelligence</p>
            <DemoDataBadge />
          </div>
          <h1 className="mt-1 text-3xl font-black text-white">Marketing Analytics</h1>
        </div>
          ...
          <div className="flex rounded-xl border border-white/10 bg-[#161817] p-1 text-xs">
            {["7d", "30d", "90d"].map((t) => (
              <button
                ...
                className={`rounded-lg px-3 py-1.5 font-bold uppercase transition ${timeFilter === t ? "bg-[#b9f42e] text-black" : "text-zinc-400 hover:text-white"}`}
              >
                {t}
              </button>
            ))}
      ...
      <div className="rounded-2xl border border-[#b9f42e]/30 bg-gradient-to-br from-[#b9f42e]/10 to-transparent p-6 shadow-2xl space-y-4">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <div className="rounded-xl border border-white/10 bg-black/40 p-4">
            <p className="text-xs font-bold uppercase tracking-wider text-zinc-500">Performance Insight</p>
          ...
          <div className="rounded-xl border border-white/10 bg-black/40 p-4">
            <p className="text-xs font-bold uppercase tracking-wider text-zinc-500">Agent Recommendation</p>
            <p className="mt-1 text-sm font-semibold text-zinc-200">
